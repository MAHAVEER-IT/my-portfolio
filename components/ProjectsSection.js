      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8 items-center">
          ...
          <div className="w-full lg:w-2/3 relative">
            <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white/70 backdrop-blur-lg shadow-2xl border border-white/40">
              {/* Project Image */}
              <div className="relative h-64 sm:h-80 md:h-107 overflow-hidden">
                <Image
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 text-white">
                <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 drop-shadow-lg">{projects[activeProject].title}</h3>
                <p className="text-white/90 mb-2 sm:mb-4 text-xs sm:text-sm drop-shadow-md max-w-2xl line-clamp-2 sm:line-clamp-3">{projects[activeProject].desc}</p>
                <p className="text-white/80 text-xs sm:text-sm font-semibold mb-4 sm:mb-6 drop-shadow-md">{projects[activeProject].tech}</p>
            ...
            <button
              ...
              className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white/60 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center hover:bg-white transition-all duration-300 hover:scale-110 z-10"
            ...
            <button
              ...
              className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white/60 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center hover:bg-white transition-all duration-300 hover:scale-110 z-10"
          ...
          <div className="w-full lg:w-1/3 flex lg:flex-col gap-3 sm:gap-4 overflow-x-auto lg:overflow-x-hidden lg:overflow-y-auto pb-4 lg:pb-0 lg:max-h-[450px] lg:pr-2 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 px-2 sm:px-4 py-3 sm:py-5">
            {projects.map((project, index) => (
              <button
                ...
                className={`relative flex-shrink-0 w-48 sm:w-56 lg:w-full h-24 sm:h-28 lg:h-32 rounded-xl sm:rounded-2xl overflow-hidden transition-all duration-300 ${
                  activeProject === index 
                    ? 'ring-2 sm:ring-4 ring-blue-500 scale-105 shadow-2xl' 
